...
uint256 hashGenesisBlock("0x0000000002af82cd0d42b85373a9f76a9b0331a81897580c4ab4c6817571caa5");
...
const string strMessageMagic = "samsungcoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000002af82cd0d42b85373a9f76a9b0331a81897580c4ab4c6817571caa5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1425731687;
        block.nBits    = 486604799;
        block.nNonce   = 459860222;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("samsungcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("samsungcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("samsungcoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running samsungcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("samsungcoinMiner terminated\n");
        throw;
    }
}
